...
import ShowInvoiceModal from "./show-invoice";
import { ORDERS, IORDER } from "../utils/utils";
  ...
  return (
    <div className="bg-white dark:bg-[#0D0D0D] border rounded-[14px] border-[#EDF2F7] dark:border-[#1A1A1A] pt-[18px] pb-[31px] px-[20px] flex gap-[14px] flex-col w-full lg:w-fit h-fit">
      <div className="flex items-center justify-between lg:w-[520px] xl:w-[766px]">
        ...
        <h2 className="text-[#34CAA5] underline-offset-4 hover:underline text-base lg:text-lg  font-medium cursor-pointer">
          See All
        </h2>
      </div>
                ...
                >
                  ...
                  <td className="">
                    <div
                      ...
                      className="flex gap-[6px] w-fit hover:underline underline-offset-4 items-center cursor-pointer"
                    >
                      {/* prettier-ignore */}
