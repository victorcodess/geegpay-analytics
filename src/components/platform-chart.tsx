...
const PlatformChart = () => {
  return (
<div className="bg-white border rounded-[14px] border-[#EDF2F7] pt-[18px] pb-[31px] px-[20px] flex gap-[20px] flex-col w-full">
              <div className="flex items-center justify-between">
                <h2 className="text-[#26282C] text-md lg:text-lg font-semibold">
                  Top Platform
                </h2>
              ...
              <div className="flex flex-col gap-5">
                <div className="flex flex-col items-start justify-center gap-4">
                  <h2 className="text-[#22242C] text-md lg:text-lg  font-semibold">
                    Book Bazaar
                  </h2>
